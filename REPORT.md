...
|------------|------|--------------|-----------------|----------------|
| **Think-Aloud Playtesting** | Observational | Participants are asked to verbalise their thoughts while playing. We observe and note hesitation, confusion, and unexpected behavior. | Provides real-time insight into players’ reasoning and helps uncover interface or control issues. | “Complete Level 1 while explaining what you’re thinking and trying to do.” |
| **Post-Session Questionnaire** | Querying | Participants complete a short form after gameplay (based on SUS or custom Likert-scale questions). | Allows quantifiable analysis of enjoyment, clarity, and difficulty across multiple users. | “Rate how intuitive the controls felt on a scale from 1–5.” |
...
| **Quantitative** | Time to complete levels, number of deaths, success rate | Built-in Unity logging |
